            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="partCode" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
    layui.use(['form', 'table', 'spLayer', 'spTable'], function () {
        ...
        var tableIns = spTable.render({
            url: '${request.contextPath}/basedata/partComponent/page',
            cols: [
                [{
                    type: 'checkbox'
                }, {
                    field: 'partCode', title: '零部件编号'
                }, {
                    field: 'partName', title: '零部件名称'
                }, {
                    field: 'partType', title: '零部件类型'
                }, {
        ...
        table.on('toolbar(js-record-table-filter)', function (obj) {
            ...
            if (obj.event === 'add') {
                var index = spLayer.open({
                    title: '添加零部件',
                    area: ['90%', '90%'],
                    content: '${request.contextPath}/basedata/partComponent/add-or-update-ui'
                });
            }
        });
        ...
        table.on('tool(js-record-table-filter)', function (obj) {
            ...
            if (obj.event === 'delete') {
                layer.confirm('确认要删除吗？', function (index) {
                    spUtil.ajax({
                        url: '${request.contextPath}/basedata/partComponent/delete',
                        async: false,
                        type: 'POST',
                        showLoading: true,
                        serializable: false,
